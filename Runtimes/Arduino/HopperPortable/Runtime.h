...
enum LibCall {
    ...
    eSPISettings = 0x000D,
    eSPIBegin = 0x000E,
    eSPIBeginTransaction = 0x000F,
    eSPIEndTransaction = 0x0010,
    eSPIReadByte = 0x0011,
    eSPIReadWord = 0x0012,
    eSPIReadBuffer = 0x0013,
    eSPIWriteByte = 0x0014,
    eSPIWriteWord = 0x0015,
    eSPIWriteBuffer = 0x0016,
    eSPISetCSPin = 0x0017,
    eSPIGetCSPin = 0x0018,
    eSPISetClkPin = 0x0019,
    eSPISetTxPin = 0x001A,
    eSPISetRxPin = 0x001B,
    eSPICSPinGet = 0x001C,
    eSPICSPinSet = 0x001D,
    eSPIClkPinSet = 0x001E,
    eSPITxPinSet = 0x001F,
    eSPIRxPinSet = 0x0020,
    eNeoPixelBegin = 0x0021,
    eNeoPixelBrightnessSet = 0x0022,
    eNeoPixelBrightnessGet = 0x0023,
    eNeoPixelSetColor = 0x0024,
    eNeoPixelShow = 0x0025,
    eNeoPixelLengthGet = 0x0026,
    eWebClientGetRequest = 0x0027,
    eWebServerBegin = 0x0028,
    eWebServerOn = 0x0029,
    eWebServerOnNotFound = 0x002A,
    eWebServerEvents = 0x002B,
    eWebServerClose = 0x002C,
    eWebServerSend = 0x002D,
};

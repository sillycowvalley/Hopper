...
enum SysCalls {
    ...
    eStringBuild = 0x0001,
    eStringNew = 0x0002,
    eStringBuildFront = 0x0003,
    eArrayNewFromConstant = 0x0004,
    eTimeSeconds = 0x0005,
    eStringLengthGet = 0x0006,
    eTimeDelay = 0x0007,
    eDiagnosticsDie = 0x0008,
    eSerialConnect = 0x0009,
    eStringGetChar = 0x000A,
    eArrayNew = 0x000B,
    eArrayCountGet = 0x000C,
    eArrayGetItem = 0x000D,
    eArraySetItem = 0x000E,
    eSerialReadChar = 0x000F,
    eSerialWriteChar = 0x0010,
    eSerialIsAvailableGet = 0x0011,
    eMemoryReadByte = 0x0012,
    eMemoryWriteByte = 0x0013,
    eMemoryAvailable = 0x0014,
    eMemoryMaximum = 0x0015,
    eMemoryAllocate = 0x0016,
    eMemoryFree = 0x0017,
    eByteToHex = 0x0018,
    eIntGetByte = 0x0019,
    ...
    eDictionaryGet = 0x00AC,
    eDictionaryNext = 0x00AD,
    eDictionaryClear = 0x00AE,
    ...
    eStringSubstring = 0x00EA,
    eStringReplace = 0x00EB,
    eFloatToUInt = 0x00EC,
    eFloatToLong = 0x00ED,
    eLongAddB = 0x00EE,
    eLongSubB = 0x00EF,
    ...
    eFloatSqrt = 0x00F3,
    eListNew = 0x00F4,
    eListCountGet = 0x00F5,
    eListAppend = 0x00F6,
    eListInsert = 0x00F7,
    eListGetItem = 0x00F8,
    eListGetItemAsVariant = 0x00F9,
    eListSetItem = 0x00FA,
    eListClear = 0x00FB,
    eListRemove = 0x00FC,
    eListContains = 0x00FD,
};
...
enum LibCall {
    ...
    eMCUTone = 0x0011,
    eMCUNoTone = 0x0012,
    eMCUAttachToPin = 0x0013,
    eMCUInterruptsEnabledGet = 0x0014,
    eMCUInterruptsEnabledSet = 0x0015,
    eMCUReboot = 0x0016,
    eMCUHeapFree = 0x0017,
    eMCUStackFree = 0x0018,
    eMCUClockSpeedGet = 0x0019,
    eMCUClockSpeedSet = 0x001A,
    eSPISettings = 0x001B,
    eSPIBegin = 0x001C,
    eSPIBeginTransaction = 0x001D,
    eSPIEndTransaction = 0x001E,
    eSPIReadByte = 0x001F,
    eSPIReadWord = 0x0020,
    eSPIReadBuffer = 0x0021,
    eSPIWriteByte = 0x0022,
    eSPIWriteBytes = 0x0023,
    eSPIWriteWord = 0x0024,
    eSPIWriteWords = 0x0025,
    eSPIWriteBuffer = 0x0026,
    eSPISetCSPin = 0x0027,
    eSPIGetCSPin = 0x0028,
    eSPISetClkPin = 0x0029,
    eSPISetTxPin = 0x002A,
    eSPISetRxPin = 0x002B,
    eSPICSPinGet = 0x002C,
    eSPICSPinSet = 0x002D,
    eSPIClkPinSet = 0x002E,
    eSPITxPinSet = 0x002F,
    eSPIRxPinSet = 0x0030,
    eNeoPixelBegin = 0x0031,
    eNeoPixelBrightnessSet = 0x0032,
    eNeoPixelBrightnessGet = 0x0033,
    eNeoPixelSetColor = 0x0034,
    eNeoPixelShow = 0x0035,
    eNeoPixelLengthGet = 0x0036,
    eWebClientGetRequest = 0x0037,
    eWebServerBegin = 0x0038,
    eWebServerOn = 0x0039,
    eWebServerOnNotFound = 0x003A,
    eWebServerEvents = 0x003B,
    eWebServerClose = 0x003C,
    eWebServerSend = 0x003D,
    eSDSPIControllerGet = 0x003E,
    eSDSPIControllerSet = 0x003F,
    eSDCSPinGet = 0x0040,
    eSDCSPinSet = 0x0041,
    eSDClkPinGet = 0x0042,
    eSDClkPinSet = 0x0043,

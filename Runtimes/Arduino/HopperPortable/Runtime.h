...
enum LibCall {
    ...
    eWiFiBeginAP = 0x0038,
    eWebServerBegin = 0x0039,
    eWebServerOn = 0x003A,
    eWebServerOnNotFound = 0x003B,
    eWebServerEvents = 0x003C,
    eWebServerClose = 0x003D,
    eWebServerSend = 0x003E,
    eSDSPIControllerGet = 0x003F,
    eSDSPIControllerSet = 0x0040,
    eSDCSPinGet = 0x0041,
    eSDCSPinSet = 0x0042,
    eSDClkPinGet = 0x0043,
    eSDClkPinSet = 0x0044,
    ...
    eSDMount = 0x0049,
    eSDEject = 0x004A,
    eStorageMediaInitialize = 0x004B,
    eStorageMediaMount = 0x004C,
    eStorageMediaUnmount = 0x004D,
    eStorageMediaReadSector = 0x004E,
    eStorageMediaWriteSector = 0x004F,
    eUARTSetup = 0x0050,
    eUARTIsAvailableGet = 0x0051,
    eUARTReadChar = 0x0052,
    eUARTWriteChar = 0x0053,
};

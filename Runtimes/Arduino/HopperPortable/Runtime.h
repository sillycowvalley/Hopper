...
enum LibCall {
    ...
    eMCUClockSpeedGet = 0x0013,
    eMCUClockSpeedSet = 0x0014,
    eTimerStart = 0x0015,
    eTimerStop = 0x0016,
    eTimerAlarm = 0x0017,
    eTimerCancel = 0x0018,
    ...
    eSPIWriteWord = 0x0021,
    eSPIWriteBuffer = 0x0022,
    eSPISetCSPin = 0x0023,
    eSPIGetCSPin = 0x0024,
    eSPISetClkPin = 0x0025,
    eSPISetTxPin = 0x0026,
    eSPISetRxPin = 0x0027,
    eSPICSPinGet = 0x0028,
    eSPICSPinSet = 0x0029,
    eSPIClkPinSet = 0x002A,
    eSPITxPinSet = 0x002B,
    eSPIRxPinSet = 0x002C,
    eNeoPixelBegin = 0x002D,
    eNeoPixelBrightnessSet = 0x002E,
    eNeoPixelBrightnessGet = 0x002F,
    eNeoPixelSetColor = 0x0030,
    eNeoPixelShow = 0x0031,
    eNeoPixelLengthGet = 0x0032,
    eWebClientGetRequest = 0x0033,
    eWebServerBegin = 0x0034,
    eWebServerOn = 0x0035,
    eWebServerOnNotFound = 0x0036,

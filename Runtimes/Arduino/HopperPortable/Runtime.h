...
enum LibCall {
    ...
    eSPISettings = 0x0015,
    eSPIBegin = 0x0016,
    eSPIBeginTransaction = 0x0017,
    eSPIEndTransaction = 0x0018,
    eSPIReadByte = 0x0019,
    eSPIReadWord = 0x001A,
    eSPIReadBuffer = 0x001B,
    eSPIWriteByte = 0x001C,
    eSPIWriteWord = 0x001D,
    eSPIWriteBuffer = 0x001E,
    eSPISetCSPin = 0x001F,
    eSPIGetCSPin = 0x0020,
    eSPISetClkPin = 0x0021,
    eSPISetTxPin = 0x0022,
    eSPISetRxPin = 0x0023,
    eSPICSPinGet = 0x0024,
    eSPICSPinSet = 0x0025,
    eSPIClkPinSet = 0x0026,
    eSPITxPinSet = 0x0027,
    eSPIRxPinSet = 0x0028,
    eNeoPixelBegin = 0x0029,
    eNeoPixelBrightnessSet = 0x002A,
    eNeoPixelBrightnessGet = 0x002B,
    eNeoPixelSetColor = 0x002C,
    eNeoPixelShow = 0x002D,
    eNeoPixelLengthGet = 0x002E,
    eWebClientGetRequest = 0x002F,
    eWebServerBegin = 0x0030,
    eWebServerOn = 0x0031,
    eWebServerOnNotFound = 0x0032,
    eWebServerEvents = 0x0033,
    eWebServerClose = 0x0034,
    eWebServerSend = 0x0035,
};

...
enum LibCall {
    ...
    eWireEndTx = 0x0002,
    eWireWrite = 0x0003,
    eGraphicsConfigureDisplay = 0x0004,
    eGraphicsConfigureSPI = 0x0005,
    eGraphicsConfigureReset = 0x0006,
    eGraphicsConfigureI2C = 0x0007,
    eGraphicsConfigureMatrix = 0x0008,
    eGraphicsBegin = 0x0009,
    eGraphicsEnd = 0x000A,
    eGraphicsInvertDisplay = 0x000B,
    eGraphicsFlipDisplay = 0x000C,
    eGraphicsClear = 0x000D,
    eGraphicsWidthGet = 0x000E,
    eGraphicsHeightGet = 0x000F,
    eGraphicsSetPixel = 0x0010,
    eGraphicsLine = 0x0011,
    eGraphicsHorizontalLine = 0x0012,
    eGraphicsVerticalLine = 0x0013,
    eGraphicsRectangle = 0x0014,

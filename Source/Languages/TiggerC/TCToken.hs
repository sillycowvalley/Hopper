unit TCToken
{
    enum TokenType
    {
        ...
        KW_BYTE, KW_WORD, KW_CHAR, KW_BOOL, KW_INT, KW_UINT, KW_AS, KW_MEM, KW_ASM, KW_SP,
        // Symbols
    ...
    Initialize()
    {
        ...
        keywords["sp"] = TokenType.KW_SP;
        keywords["asm"] = TokenType.KW_ASM;
    }
    ...
    string ToString(TokenType tp)
    {
        switch (tp)
        {
            ...
            case TokenType.KW_SP: { return "KW_SP"; }

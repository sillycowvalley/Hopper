unit Board // Challenger 2040 WiFi6 BLE
{
    #define CHALLENGER_2040_WIFI6_BLE
    ...
    const byte D8 = 1;
    const byte D9 = 6;
    const byte D10 = 7;  // BuiltInLED
    const byte D11 = 8;  // BuiltInNeoPixel
    const byte D12 = 9;  // SPI1Rx
    const byte D13 = 10; // SPI1SS
    const byte D14 = 11; // SPI1SCK
    const byte D15 = 12; // SPI1Tx
    const byte D16 = 13; // UART1Tx
    const byte D17 = 14; // UART1Rx
    const byte D18 = 15;
    const byte D19 = 18;
    const byte D20 = 19;
